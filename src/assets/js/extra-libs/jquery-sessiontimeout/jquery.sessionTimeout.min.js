      ...
      var u = d.countdownMessage
          ? "<p>" +
            d.countdownMessage.replace(
              /{timer}/g,
              '<span className="countdown-holder"></span>'
            ) +
            "</p>"
          : "",
        c = d.countdownBar
          ? '<div className="progress" style="height: 15px;">                   <div className="progress-bar bg-info countdown-bar active" role="progressbar" style="min-width: 15px; width: 100%;">                     <span className="countdown-holder"></span>                   </div>                 </div>'
          : "";
      e("body").append(
        '<div className="modal fade" id="session-timeout-dialog">               <div className="modal-dialog">                 <div className="modal-content">                   <div className="modal-header">                                          <h4 className="modal-title">' +
          d.title +
          '</h4>    <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>               </div>                   <div className="modal-body">                     <p>' +
          d.message +
          "</p>                     " +
          u +
          "                     " +
          c +
          '                   </div>                   <div className="modal-footer">                     <button id="session-timeout-dialog-logout" type="button" className="btn btn-danger">' +
          d.logoutButton +
          '</button>                     <button id="session-timeout-dialog-keepalive" type="button" className="btn btn-success" data-dismiss="modal">' +
          d.keepAliveButton +
