...
// import { initializeDashboard2 } from "../../../helper/js";


export default function ECommerce() {
  onMount(() => {
    import("../../../assets/js/dashboards/dashboard.js").then(({ initializeDashboard }) => {
      initializeDashboard();
    });
  });
  return (
        ...
        <div class="page-titles mb-5">
          <div class="row">
            <div class="col-lg-8 col-md-6 col-12 align-self-center">
              <h4 class="text-muted mb-0 fw-normal fs-5">Welcome Johnathan</h4>
            ...
            <div class="card-group">
              <div class="card">
                <div class="card-body">
                  ...
                  <h3 class="mt-3 pt-1 mb-0 fs-6">39,354
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <h3 class="mt-3 pt-1 mb-0 fs-6">4396
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <h3 class="mt-3 pt-1 mb-0 fs-6 d-flex align-items-center">423,39
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <h3 class="mt-3 pt-1 mb-0 fs-6">835
              ...
              <div class="card-body">
                ...
                <div class="row mt-4">
                  <div class="col-md-5 border-end">
                    <div class="pe-4">
                      <h3 class="fs-8 d-flex align-items-center mb-0">$93,438.78
                      ...
                      <h3 class="fs-8 d-flex align-items-center mb-0 mt-4">$32,839.00</h3>
                      <h6 class="fw-normal text-muted mb-0">Expence</h6>
                      <div class="mt-3 mb-4">
                        <div id="budget-expence-side-chart">
                        </div>
                      </div>
                  ...
                  <div class="col-md-7">
                    <div id="product-performance" class="ps-3">
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card-body">
                ...
                <div class="d-flex align-items-center my-3 py-1">
                  ...
                  <div class="ms-3 ps-1">
                    ...
                    <h6 class="text-muted fw-normal mb-0 fs-3">Money reversed</h6>
                  </div>
                  <h6 class="ms-auto text-success">+$350</h6>
                </div>
                <div class="d-flex align-items-center my-3 py-1">
                ...
                <div class="d-flex align-items-center">
                  ...
                  <div class="ms-auto">
                    <span class="fs-3 text-muted">36 Recent Transactions</span>
                  </div>
                </div>
              </div>
            </div>
                          ...
                          <tr>
                            <td class="px-0">
                              <div class="d-flex align-items-center">
                                ...
                                <div class="ms-4">
                                  <h5 class="mb-0 fs-4">Supreme toys presents best gift</h5>
                            ...
                            <td>
                              ...
                              <h6 class="text-muted fw-normal mt-2">98% Sold</h6>
                            </td>
                            <td>
                          ...
                          <tr>
                            <td class="px-0">
                              <div class="d-flex align-items-center">
                                ...
                                <div class="ms-4">
                                  <h5 class="mb-0 fs-4">Red color shoes from Gucci</h5>
                            ...
                            <td>
                              ...
                              <h6 class="text-muted fw-normal mt-2">46% Sold</h6>
                            </td>
                            <td>
                              <span class="fs-3 text-muted fw-normal">Earnings</span>
                              <h5 class="mb-0 fs-4">$546,000</h5>
                          ...
                          <tr>
                            <td class="px-0">
                              <div class="d-flex align-items-center">
                                ...
                                <div class="ms-4">
                                  <h5 class="mb-0 fs-4">Nike branding shoes for Men and Women</h5>
                            ...
                            <td>
                              ...
                              <h6 class="text-muted fw-normal mt-2">65% Sold</h6>
                            </td>
                            <td>
                              <span class="fs-3 text-muted fw-normal">Earnings</span>
                              <h5 class="mb-0 fs-4">$546,000</h5>
                          ...
                          <tr>
                            <td class="px-0 pb-0">
                              <div class="d-flex align-items-center">
                                ...
                                <div class="ms-4">
                                  <h5 class="mb-0 fs-4">Stylish sneakers for men and women</h5>
                                  <span class="text-muted fs-3 mt-2">Bootstrap, Angular, React</span>
                                </div>
                              </div>
                            </td>
                            <td class="pb-0">
                              ...
                              <h6 class="text-muted fw-normal mt-2">23% Sold</h6>
                            </td>
                            <td class="pb-0">
                              <span class="fs-3 text-muted fw-normal">Earnings</span>
                              <h5 class="mb-0 fs-4">$546,000</h5>
              ...
              <div class="card-body">
                ...
                <div class="mt-4">
                  ...
                  <div class="d-flex align-items-center mt-3">
                    <a href="javascript:void(0)" class="btn btn-info">Add</a>
                    <div class="ms-auto">
                      <span class="fs-3 text-muted">28 Team Members, 268 Tasks</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="mt-4 pt-2">
                  ...
                  <h4 class="card-title mt-4 mb-1">Angular 12 coming soon!</h4>
                  <span class="text-muted">By
                    <a href="javascript:void(0)" class="text-primary">Johnathan Doe</a>
                  </span>
                  <p class="fs-3 mt-4 text-muted">This will be the small description for the news you have shown here. There could be some great info.</p>
