    ...
    <div className="continer">
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="card welcome-card overflow-hidden bg-primary-subtle border-0">
            <div class="card-body">
              ...
              <a
                href="javascript:void(0)"
                class="btn btn-primary mb-4 mt-3 position-relative"
              >
                Download
              </a>
            </div>
            ...
            <div class="col-md-6">
              <div class="card overflow-hidden">
                <div class="card-body">
                  <div class="d-flex align-items-center justify-content-between">
                    <div>
                      <h5 class="fw-normal mb-0 fs-4 text-muted">
                        Monthly Sales
                      </h5>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td class="px-0">
                        <div class="d-flex align-items-center">
                          <img
                            src="\src\assets\images\profile\user-5.jpg"
                            class="rounded-circle"
                            width="35"
                            alt="flexy"
                          />
                    ...
                    <tr>
                      <td class="px-0">
                        <div class="d-flex align-items-center">
                          <img
                            src="src\assets\images\profile\user-6.jpg"
                            class="rounded-circle"
                            width="35"
                            alt="flexy"
                          />
                    ...
                    <tr>
                      <td class="px-0">
                        <div class="d-flex align-items-center">
                          <img
                            src="src\assets\images\profile\user-7.jpg"
                            class="rounded-circle"
                            width="35"
                            alt="flexy"
                          />
                    ...
                    <tr>
                      <td class="px-0">
                        <div class="d-flex align-items-center">
                          <img
                            src="src\assets\images\profile\user-8.jpg"
                            class="rounded-circle"
                            width="35"
                            alt="flexy"
                          />
        ...
        <div class="col-lg-4">
          <div class="card">
            <img
              src="./assets/images/backgrounds/blog-bg.jpg"
              class="card-img-top blog-img"
              alt="..."
            />
            <div class="card-body">
              <div class="d-flex align-items-center text-muted">
                <i class="ti ti-clock me-1 fs-6"></i>
                22 March, 2024
              </div>
              ...
              <div class="border-top pt-4 d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                  ...
                  <a
                    href="javascript:void(0)"
                    class="me-1 round-md rounded-circle d-flex align-items-center justify-content-center bg-success-subtle round-40 text-success"
                    data-bs-toggle="tooltip"
                    data-bs-placement="top"
                    title="Add new"
                  >
