  ...
  <div class="row">
      ...
      <div class="card overflow-hidden hover-img">
        <div class="position-relative">
          <a href="javascript:void(0)">
            <img src="../assets/images/blog/blog-img1.jpg" class="card-img-top" alt="flexy-img" />
          </a>
          ...
          <img src="../assets/images/profile/user-3.jpg" alt="flexy-img" class="img-fluid rounded-circle position-absolute bottom-0 start-0 mb-n9 ms-9" width="40" height="40" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Georgeanna Ramero" />
        </div>
    ...
    <div class="col-lg-4">
      <div class="card overflow-hidden hover-img">
        <div class="position-relative">
          <a href="javascript:void(0)">
            <img src="../assets/images/blog/blog-img2.jpg" class="card-img-top" alt="flexy-img" />
          </a>
          <span class="badge text-bg-light text-dark fs-2 lh-sm mb-9 me-9 py-1 px-2 fw-semibold position-absolute bottom-0 end-0">2 min Read</span>
          <img src="../assets/images/profile/user-2.jpg" alt="flexy-img" class="img-fluid rounded-circle position-absolute bottom-0 start-0 mb-n9 ms-9" width="40" height="40" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Georgeanna Ramero" />
        </div>
        <div class="card-body p-4">
    ...
    <div class="col-lg-4">
      <div class="card overflow-hidden hover-img">
        <div class="position-relative">
          <a href="javascript:void(0)">
            <img src="../assets/images/blog/blog-img3.jpg" class="card-img-top" alt="flexy-img" />
          </a>
          <span class="badge text-bg-light text-dark fs-2 lh-sm mb-9 me-9 py-1 px-2 fw-semibold position-absolute bottom-0 end-0">2 min Read</span>
          <img src="../assets/images/profile/user-3.jpg" alt="flexy-img" class="img-fluid rounded-circle position-absolute bottom-0 start-0 mb-n9 ms-9" width="40" height="40" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Georgeanna Ramero" />
        </div>
    ...
    <div class="col-md-6 col-lg-3">
      <div class="card overflow-hidden">
        <div class="position-relative">
          <a href="javascript:void(0)">
            <img src="../assets/images/products/s4.jpg" class="card-img-top" alt="flexy-img" />
          </a>
    ...
    <div class="col-md-6 col-lg-3">
      <div class="card overflow-hidden">
        <div class="position-relative">
          <a href="javascript:void(0)">
            <img src="../assets/images/products/s5.jpg" class="card-img-top" alt="flexy-img" />
          </a>
          <a href="javascript:void(0)" class="btn btn-primary rounded-circle p-2 d-flex align-items-center justify-content-center position-absolute bottom-0 end-0 me-3 mb-n3">
            <i class="ti ti-basket" />
          </a>
    ...
    <div class="col-md-6 col-lg-3">
      <div class="card overflow-hidden">
        <div class="position-relative">
          <a href="javascript:void(0)">
            <img src="../assets/images/products/s7.jpg" class="card-img-top" alt="flexy-img" />
          </a>
          <a href="javascript:void(0)" class="btn btn-primary rounded-circle p-2 d-flex align-items-center justify-content-center position-absolute bottom-0 end-0 me-3 mb-n3">
            <i class="ti ti-basket" />
          </a>
    ...
    <div class="col-md-6 col-lg-3">
      <div class="card overflow-hidden">
        <div class="position-relative">
          <a href="javascript:void(0)">
            <img src="../assets/images/products/s11.jpg" class="card-img-top" alt="flexy-img" />
          </a>
          <a href="javascript:void(0)" class="btn btn-primary rounded-circle p-2 d-flex align-items-center justify-content-center position-absolute bottom-0 end-0 me-3 mb-n3">
            <i class="ti ti-basket" />
          </a>
        ...
        <div class="row">
          ...
          <div class="col-6 ps-0">
            <div class="position-relative w-100 h-100">
              <img src="../assets/images/blog/blog-img5.jpg" class="w-100 h-100 rounded-0" alt="flexy-img" />
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="col-md-4">
      <div class="card overflow-hidden">
        <div class="row">
          ...
          <div class="col-6 ps-0">
            <div class="position-relative w-100 h-100">
              <img src="../assets/images/blog/blog-img4.jpg" class="w-100 h-100 rounded-0" alt="flexy-img" />
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="col-md-4">
      <div class="card overflow-hidden">
        <div class="row">
          ...
          <div class="col-6 ps-0">
            <div class="position-relative w-100 h-100">
              <img src="../assets/images/blog/blog-img3.jpg" class="w-100 h-100 rounded-0" alt="flexy-img" />
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="col-sm-6 col-lg-3">
      <div class="card">
        <div class="card-body p-4">
          <img src="../assets/images/profile/user-11.jpg" alt="flexy-img" class="img-fluid rounded-circle mb-4" width="80" height="80" />
          <h4 class="card-title">Andrew Grant</h4>
          <div class="d-flex align-items-center gap-4 mb-4">
            <div class="d-flex align-items-center">
              <a href="javascript:void(0)">
                <img src="../assets/images/profile/user-12.jpg" class="rounded-circle me-n2 card-hover border border-white" width="32" height="32" />
              </a>
              <a href="javascript:void(0)">
                <img src="../assets/images/profile/user-2.jpg" class="rounded-circle me-n2 card-hover border border-white" width="32" height="32" />
              </a>
              <a href="javascript:void(0)">
                <img src="../assets/images/profile/user-3.jpg" class="rounded-circle me-n2 card-hover border border-white" width="32" height="32" />
              </a>
            </div>
    ...
    <div class="col-sm-6 col-lg-3">
      <div class="card">
        <div class="card-body p-4">
          <img src="../assets/images/profile/user-2.jpg" alt="flexy-img" class="img-fluid rounded-circle mb-4" width="80" height="80" />
          <h4 class="card-title">Leo Pratt</h4>
          <div class="d-flex align-items-center gap-4 mb-4">
            <div class="d-flex align-items-center">
              <a href="javascript:void(0)">
                <img src="../assets/images/profile/user-11.jpg" class="rounded-circle me-n2 card-hover border border-white" width="32" height="32" />
              </a>
              <a href="javascript:void(0)">
                <img src="../assets/images/profile/user-2.jpg" class="rounded-circle me-n2 card-hover border border-white" width="32" height="32" />
              </a>
    ...
    <div class="col-sm-6 col-lg-3">
      <div class="card">
        <div class="card-body p-4">
          <img src="../assets/images/profile/user-3.jpg" alt="flexy-img" class="img-fluid rounded-circle mb-4" width="80" height="80" />
    ...
    <div class="col-sm-6 col-lg-3">
      <div class="card">
        <div class="card-body p-4">
          <img src="../assets/images/profile/user-4.jpg" alt="flexy-img" class="img-fluid rounded-circle mb-4" width="80" height="80" />
          <h4 class="card-title">Lora Powers</h4>
          <div class="d-flex align-items-center gap-4 mb-4">
            <div class="d-flex align-items-center">
              <a href="javascript:void(0)">
                <img src="../assets/images/profile/user-9.jpg" class="rounded-circle me-n2 card-hover border border-white" width="32" height="32" />
              </a>
              <a href="javascript:void(0)">
                <img src="../assets/images/profile/user-2.jpg" class="rounded-circle me-n2 card-hover border border-white" width="32" height="32" />
              </a>
    ...
    <div class="col-md-4">
      <div class="card">
        <div class="card-body p-4">
          ...
          <img src="../assets/images/products/s1.jpg" alt="flexy-img" class="card-img w-100 object-fit-cover mb-4" height="160" />
    ...
    <div class="col-md-4">
      <div class="card">
        <div class="card-body p-4">
          ...
          <img src="../assets/images/products/s2.jpg" alt="flexy-img" class="card-img w-100 object-fit-cover mb-4" height="160" />
          <button class="btn btn-primary w-100 fw-normal py-8">Gift to Friend ($50.00)</button>
        </div>
      </div>
    </div>
            ...
            <div class="d-flex align-items-center justify-content-between mb-4">
              <div class="d-flex">
                <div class="p-8 bg-primary-subtle rounded-1 d-flex align-items-center justify-content-center me-6">
                  <img src="../assets/images/svgs/icon-paypal.svg" alt="flexy-img" class="img-fluid" width="24" height="24" />
                </div>
                <div>
            ...
            <div class="d-flex align-items-center justify-content-between mb-4">
              <div class="d-flex">
                <div class="p-8 bg-success-subtle rounded-1 d-flex align-items-center justify-content-center me-6">
                  <img src="../assets/images/svgs/icon-office-bag.svg" alt="flexy-img" class="img-fluid" width="24" height="24" />
                </div>
                <div>
            ...
            <div class="d-flex align-items-center justify-content-between mb-4">
              <div class="d-flex">
                <div class="p-8 bg-warning-subtle rounded-1 d-flex align-items-center justify-content-center me-6">
                  <img src="../assets/images/svgs/icon-master-card.svg" alt="flexy-img" class="img-fluid" width="24" height="24" />
                </div>
                <div>
            ...
            <div class="d-flex align-items-center justify-content-between mb-7 pb-8">
              <div class="d-flex">
                <div class="p-8 bg-danger-subtle rounded-1 d-flex align-items-center justify-content-center me-6">
                  <img src="../assets/images/svgs/icon-pie.svg" alt="flexy-img" class="img-fluid" width="24" height="24" />
                </div>
                <div>
        ...
        <div class="card-body p-4">
          ...
          <div class="position-relative">
            <div class="d-flex align-items-center justify-content-between mb-4">
              <div class="d-flex">
                <div class="p-8 bg-primary-subtle rounded-1 d-flex align-items-center justify-content-center me-6">
                  <img src="../assets/images/svgs/icon-map-pin.svg" alt="flexy-img" class="img-fluid" width="24" height="24" />
                </div>
                <div>
            ...
            <div class="d-flex align-items-center justify-content-between mb-4">
              <div class="d-flex">
                <div class="p-8 bg-info-subtle rounded-1 d-flex align-items-center justify-content-center me-6">
                  <img src="../assets/images/svgs/icon-database.svg" alt="flexy-img" class="img-fluid" width="24" height="24" />
                </div>
                <div>
            ...
            <div class="d-flex align-items-center justify-content-between mb-4">
              <div class="d-flex">
                <div class="p-8 bg-warning-subtle rounded-1 d-flex align-items-center justify-content-center me-6">
                  <img src="../assets/images/svgs/icon-phone.svg" alt="flexy-img" class="img-fluid" width="24" height="24" />
                </div>
                <div>
            ...
            <div class="d-flex align-items-center justify-content-between mb-4">
              <div class="d-flex">
                <div class="p-8 bg-danger-subtle rounded-1 d-flex align-items-center justify-content-center me-6">
                  <img src="../assets/images/svgs/icon-screen-share.svg" alt="flexy-img" class="img-fluid" width="24" height="24" />
                </div>
                <div>
            ...
            <div class="d-flex align-items-center justify-content-between">
              <div class="d-flex flex-shrink-0">
                <div class="p-8 bg-success-subtle rounded-1 d-flex align-items-center justify-content-center me-6">
                  <img src="../assets/images/svgs/icon-mail.svg" alt="flexy-img" class="img-fluid" width="24" height="24" />
                </div>
                <div>
