        ...
        <div class="row">
          <div class="col-lg-8">
                ...
                <div class="row justify-content-between align-items-center">
                  ...
                  <div class="col-sm-5">
                    <div class="position-relative mb-n7 text-end">
                      <img src="../assets/images/backgrounds/welcome-bg2.png" alt="flexy-img" class="img-fluid" />
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="row justify-content-between align-items-center">
                  ...
                  <div class="col-sm-5">
                    <div class="position-relative mb-n5 text-center">
                      <img src="../assets/images/backgrounds/track-bg.png" alt="flexy-img" class="img-fluid" width="180" height="230" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="card">
                  <div class="card-body text-center">
                    <img src="../assets/images/backgrounds/website-under-construction.svg" alt="flexy-img" class="img-fluid mb-4" width="200" />
              ...
              <div class="col-md-6">
                <div class="card">
                  <div class="card-body text-center">
                    <img src="../assets/images/products/empty-shopping-bag.gif" alt="flexy-img" class="img-fluid mb-4" width="200" />
          ...
          <div class="col-lg-4">
            <div class="card">
              <div class="card-body text-center">
                <p>LEVEL UP</p>
                <img src="../assets/images/backgrounds/gold.png" alt="flexy-img" class="img-fluid mb-4" width="150" />
            ...
            <div class="card">
              <div class="card-body text-center">
                ...
                <div class="position-relative overflow-hidden d-inline-block">
                  <img src="../assets/images/profile/user-3.jpg" alt="flexy-img" class="img-fluid mb-4 rounded-circle position-relative" width="140" />
