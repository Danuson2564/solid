          ...
          <div class="page-titles mb-7 mb-md-5">
            <div class="row">
              <div class="col-lg-8 col-md-6 col-12 align-self-center">
                ...
                <h2 class="mb-0 fw-bolder fs-8">Contact Application</h2>
              </div>
                      ...
                      <ul class="chat-users mh-n100" data-simplebar="">
                        <li>
                          <a href="javascript:void(0)" class="px-4 py-3 bg-hover-light-black d-flex align-items-center chat-user bg-light-subtle" id="chat_user_1" data-user-id="1">
                            ...
                            <div class="ms-6 d-inline-block w-75">
                              ...
                              <span class="fs-2 text-body-color d-block">barstow@ spike.com</span>
                            </div>
                          </a>
                        </li>
                        <li>
                          <a href="javascript:void(0)" class="px-4 py-3 bg-hover-light-black d-flex align-items-center chat-user" id="chat_user_2" data-user-id="2">
                            ...
                            <div class="ms-6 d-inline-block w-75">
                              ...
                              <span class="fs-2 text-body-color d-block">jonathan_hig@spike.com</span>
                            </div>
                          </a>
                        </li>
                        <li>
                        ...
                        <li>
                          <a href="javascript:void(0)" class="px-4 py-3 bg-hover-light-black d-flex align-items-center chat-user" id="chat_user_4" data-user-id="4">
                            <span class="position-relative">
                              <img src="../assets/images/profile/user-7.jpg" alt="user8" width="40" height="40" class="rounded-circle" />
                            </span>
                            <div class="ms-6 d-inline-block w-75">
                        ...
                        <li>
                          <a href="javascript:void(0)" class="px-4 py-3 bg-hover-light-black d-flex align-items-center chat-user" id="chat_user_5" data-user-id="5">
                            <span class="position-relative">
                              <img src="../assets/images/profile/user-8.jpg" alt="user2" width="40" height="40" class="rounded-circle" />
                            </span>
                            <div class="ms-6 d-inline-block w-75">
                              <h6 class="mb-1 fw-semibold chat-title" data-username="James Anderson">Rick Wright</h6>
                              <span class="fs-2 text-body-color d-block">rockwright@spike.com</span>
                            </div>
                          </a>
                        </li>
                        <li>
                          <a href="javascript:void(0)" class="px-4 py-3 bg-hover-light-black d-flex align-items-center chat-user" id="chat_user_6" data-user-id="6">
                            <span class="position-relative">
                              <img src="../assets/images/profile/user-9.jpg" alt="user1" width="40" height="40" class="rounded-circle" />
                            </span>
                            <div class="ms-6 d-inline-block w-75">
                        ...
                        <li>
                          <a href="javascript:void(0)" class="px-4 py-3 bg-hover-light-black d-flex align-items-center chat-user" id="chat_user_7" data-user-id="7">
                            <span class="position-relative">
                              <img src="../assets/images/profile/user-11.jpg" alt="user3" width="40" height="40" class="rounded-circle" />
                            </span>
                            <div class="ms-6 d-inline-block w-75">
                              <h6 class="mb-1 fw-semibold chat-title" data-username="James Anderson">Peter Thornton</h6>
                              <span class="fs-2 text-body-color d-block">peter293@spike.com</span>
                            </div>
                          </a>
                        </li>
                        <li>
                          <a href="javascript:void(0)" class="px-4 py-3 bg-hover-light-black d-flex align-items-center chat-user" id="chat_user_8" data-user-id="8">
                            <span class="position-relative">
                              <img src="../assets/images/profile/user-8.jpg" alt="user1" width="40" height="40" class="rounded-circle" />
                            </span>
                            <div class="ms-6 d-inline-block w-75">
                        ...
                        <li>
                          <a href="javascript:void(0)" class="px-4 py-3 bg-hover-light-black d-flex align-items-center chat-user" id="chat_user_9" data-user-id="9">
                            ...
                            <div class="ms-6 d-inline-block w-75">
                              ...
                              <span class="fs-2 text-body-color d-block">michael_knight@spike.com</span>
                            </div>
                          </a>
                        </li>
                        <li>
                          <a href="javascript:void(0)" class="px-4 py-3 bg-hover-light-black d-flex align-items-center chat-user" id="chat_user_10" data-user-id="10">
                            <span class="position-relative">
                              <img src="../assets/images/profile/user-12.jpg" alt="user1" width="40" height="40" class="rounded-circle" />
                            </span>
                            <div class="ms-6 d-inline-block w-75">
                          ...
                          <div class="position-relative">
                            <div class="chat-box email-box mh-n100 p-9" data-simplebar="init">
                              ...
                              <div class="chat-list chat active-chat" data-user-id="1">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-8 mb-7">
                                    ...
                                    <h6 class="fw-semibold mb-0">alexandra@spike.com</h6>
                                  </div>
                              ...
                              <div class="chat-list chat" data-user-id="3">
                                <div class="hstack align-items-start mb-7 pb-1 align-items-center justify-content-between">
                                  <div class="d-flex align-items-center gap-3">
                                    <img src="../assets/images/profile/user-6.jpg" alt="user3" width="72" height="72" class="rounded-circle" />
                                    <div>
                                      <h6 class="fs-4 mb-0">Michael Knight </h6>
                                      <p class="mb-0">Sales Manager</p>
                                      <p class="mb-0">Digital Arc Pvt. Ltd.</p>
                                    </div>
                                  </div>
                              ...
                              <div class="chat-list chat" data-user-id="4">
                                <div class="hstack align-items-start mb-7 pb-1 align-items-center justify-content-between">
                                  <div class="d-flex align-items-center gap-3">
                                    <img src="../assets/images/profile/user-7.jpg" alt="user8" width="72" height="72" class="rounded-circle" />
                                    <div>
                                      <h6 class="fs-4 mb-0">Angus MacGyver</h6>
                                      <p class="mb-0">Sales Manager</p>
                                      <p class="mb-0">Digital Arc Pvt. Ltd.</p>
                                    </div>
                                  </div>
                              ...
                              <div class="chat-list chat" data-user-id="5">
                                <div class="hstack align-items-start mb-7 pb-1 align-items-center justify-content-between">
                                  <div class="d-flex align-items-center gap-3">
                                    <img src="../assets/images/profile/user-8.jpg" alt="user2" width="72" height="72" class="rounded-circle" />
                                    <div>
                                      <h6 class="fs-4 mb-0">Rick Wright</h6>
                                      <p class="mb-0">Sales Manager</p>
                                      <p class="mb-0">Digital Arc Pvt. Ltd.</p>
                                    </div>
                                  </div>
                              ...
                              <div class="chat-list chat" data-user-id="6">
                                <div class="hstack align-items-start mb-7 pb-1 align-items-center justify-content-between">
                                  <div class="d-flex align-items-center gap-3">
                                    <img src="../assets/images/profile/user-9.jpg" alt="user1" width="72" height="72" class="rounded-circle" />
                                    <div>
                                      <h6 class="fs-4 mb-0">Sledge Hammer</h6>
                                      <p class="mb-0">Sales Manager</p>
                                      <p class="mb-0">Digital Arc Pvt. Ltd.</p>
                                    </div>
                                  </div>
                              ...
                              <div class="chat-list chat" data-user-id="7">
                                <div class="hstack align-items-start mb-7 pb-1 align-items-center justify-content-between">
                                  <div class="d-flex align-items-center gap-3">
                                    <img src="../assets/images/profile/user-11.jpg" alt="user3" width="72" height="72" class="rounded-circle" />
                                    <div>
                                      <h6 class="fs-4 mb-0">Peter Thornton</h6>
                                      <p class="mb-0">Sales Manager</p>
                                      <p class="mb-0">Digital Arc Pvt. Ltd.</p>
                                    </div>
                                  </div>
                              ...
                              <div class="chat-list chat" data-user-id="8">
                                <div class="hstack align-items-start mb-7 pb-1 align-items-center justify-content-between">
                                  <div class="d-flex align-items-center gap-3">
                                    <img src="../assets/images/profile/user-8.jpg" alt="user1" width="72" height="72" class="rounded-circle" />
                                    <div>
                                      <h6 class="fs-4 mb-0">Devon Miles</h6>
                                      <p class="mb-0">Sales Manager</p>
                                      <p class="mb-0">Digital Arc Pvt. Ltd.</p>
                                    </div>
                                  </div>
                              ...
                              <div class="chat-list chat" data-user-id="10">
                                <div class="hstack align-items-start mb-7 pb-1 align-items-center justify-content-between">
                                  <div class="d-flex align-items-center gap-3">
                                    <img src="../assets/images/profile/user-12.jpg" alt="user1" width="72" height="72" class="rounded-circle" />
                                    <div>
                                      <h6 class="fs-4 mb-0">Mike Torello</h6>
                                      <p class="mb-0">Sales Manager</p>
                                      <p class="mb-0">Digital Arc Pvt. Ltd.</p>
                                    </div>
                                  </div>
