          ...
          <div class="page-titles mb-7 mb-md-5">
            <div class="row">
              <div class="col-lg-8 col-md-6 col-12 align-self-center">
                ...
                <h2 class="mb-0 fw-bolder fs-8">Chat</h2>
              </div>
                  ...
                  <div class="d-flex align-items-center justify-content-between mb-3">
                    <div class="d-flex align-items-center">
                      <div class="position-relative">
                        <img src="src\assets\images\profile\user-1.jpg" alt="user1" width="54" height="54" class="rounded-circle"/>
                        <span class="position-absolute bottom-0 end-0 p-1 badge rounded-pill bg-success">
                          <span class="visually-hidden">New alerts</span>
                        </span>
                      </div>
                      <div class="ms-3">
                        <h6 class="fw-semibold mb-2">Johnathan Doe</h6>
                        <p class="mb-0 fs-2">Administrator</p>
                      </div>
                    </div>
                    <div class="dropdown">
                  ...
                  <ul class="chat-users mb-0 mh-n100" data-simplebar="">
                      ...
                      <a href="javascript:void(0)" class="px-4 py-3 bg-hover-light-black d-flex align-items-start justify-content-between chat-user bg-light-subtle" id="chat_user_1" data-user-id="1">
                        <div class="d-flex align-items-center">
                          <span class="position-relative">
                            <img src="src\assets\images\profile\user-3.jpg" alt="user1" width="48" height="48" class="rounded-circle"/>
                            <span class="position-absolute bottom-0 end-0 p-1 badge rounded-pill bg-success">
                              <span class="visually-hidden">New alerts</span>
                            </span>
                          </span>
                    ...
                    <li>
                      <a href="javascript:void(0)" class="px-4 py-3 bg-hover-light-black d-flex align-items-start justify-content-between chat-user" id="chat_user_2" data-user-id="2">
                        <div class="d-flex align-items-center">
                          <span class="position-relative">
                            <img src="src\assets\images\profile\user-2.jpg" alt="user-2" width="48" height="48" class="rounded-circle"/>
                    ...
                    <li>
                      <a href="javascript:void(0)" class="px-4 py-3 bg-hover-light-black d-flex align-items-start justify-content-between chat-user" id="chat_user_3" data-user-id="3">
                        <div class="d-flex align-items-center">
                          <span class="position-relative">
                            <img src="src\assets\images\profile\user-8.jpg" alt="user-8" width="48" height="48" class="rounded-circle"/>
                    ...
                    <li>
                      <a href="javascript:void(0)" class="px-4 py-3 bg-hover-light-black d-flex align-items-start justify-content-between chat-user" id="chat_user_4" data-user-id="4">
                        <div class="d-flex align-items-center">
                          <span class="position-relative">
                            <img src="src\assets\images\profile\user-4.jpg" alt="user-4" width="48" height="48" class="rounded-circle"/>
                            <span class="position-absolute bottom-0 end-0 p-1 badge rounded-pill bg-success">
                              <span class="visually-hidden">New alerts</span>
                            </span>
                          </span>
                    ...
                    <li>
                      <a href="javascript:void(0)" class="px-4 py-3 bg-hover-light-black d-flex align-items-start justify-content-between chat-user" id="chat_user_5" data-user-id="5">
                        <div class="d-flex align-items-center">
                          <span class="position-relative">
                            <img src="src\assets\images\profile\user-6.jpg" alt="user1" width="48" height="48" class="rounded-circle"/>
                            <span class="position-absolute bottom-0 end-0 p-1 badge rounded-pill bg-success">
                              <span class="visually-hidden">New alerts</span>
                            </span>
                          </span>
                        ...
                        <div class="chat-box-inner p-9" data-simplebar="">
                          <div class="chat-list chat active-chat" data-user-id="1">
                            <div class="hstack gap-3 align-items-start mb-7 justify-content-start">
                              <img src="src\assets\images\profile\user-8.jpg" alt="user8" width="40" height="40" class="rounded-circle" />
                              <div>
                            ...
                            <div class="hstack gap-3 align-items-start mb-7 justify-content-start">
                              ...
                              <div>
                                ...
                                <div class="rounded-2 overflow-hidden">
                                  <img src="../assets/images/products/product-1.jpg" alt="flexy-img" class="w-100" />
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="offcanvas-body p-9">
                            ...
                            <div class="row mb-7 text-nowrap">
                              <div class="col-4 px-1 mb-2">
                                ...
                                <img src="../assets/images/products/product-1.jpg" width="88" height="65" alt="flexy-img" class="rounded" />

                              </div>
                              <div class="col-4 px-1 mb-2">

                                <img src="../assets/images/products/product-2.jpg" width="88" height="65" alt="flexy-img" class="rounded" />

                              </div>
                              <div class="col-4 px-1 mb-2">

                                <img src="../assets/images/products/product-3.jpg" width="88" height="65" alt="flexy-img" class="rounded" />

                              </div>
                              <div class="col-4 px-1 mb-2">

                                <img src="../assets/images/products/product-4.jpg" width="88" height="65" alt="flexy-img" class="rounded" />
                            ...
                            <div class="files-chat">
                              ...
                              <a href="javascript:void(0)" class="hstack gap-3 file-chat-hover justify-content-between text-nowrap mb-9">
                                <div class="d-flex align-items-center gap-3">
                                  <div class="rounded-1 text-bg-light p-6">
                                    <img src="../assets/images/chat/icon-adobe.svg" alt="flexy-img" width="24" height="24" />
                                  </div>
                                  <div>
                              ...
                              <a href="javascript:void(0)" class="hstack gap-3 file-chat-hover justify-content-between text-nowrap mb-9">
                                <div class="d-flex align-items-center gap-3">
                                  <div class="rounded-1 text-bg-light p-6">
                                    <img src="../assets/images/chat/icon-figma.svg" alt="flexy-img" width="24" height="24" />
                                  </div>
                                  <div>
                                    <h6 class="fw-semibold">
                                      homepage-design.fig
                              ...
                              <a href="javascript:void(0)" class="hstack gap-3 file-chat-hover justify-content-between text-nowrap mb-9">
                                <div class="d-flex align-items-center gap-3">
                                  <div class="rounded-1 text-bg-light p-6">
                                    <img src="../assets/images/chat/icon-chrome.svg" alt="flexy-img" width="24" height="24" />
                                  </div>
                                  <div>
                              ...
                              <a href="javascript:void(0)" class="hstack gap-3 file-chat-hover justify-content-between text-nowrap mb-9">
                                <div class="d-flex align-items-center gap-3">
                                  <div class="rounded-1 text-bg-light p-6">
                                    <img src="../assets/images/chat/icon-zip-folder.svg" alt="flexy-img" width="24" height="24" />
                                  </div>
                                  <div>
                                    <h6 class="fw-semibold">
                                      work-project.zip
                              ...
                              <a href="javascript:void(0)" class="hstack gap-3 file-chat-hover justify-content-between text-nowrap">
                                <div class="d-flex align-items-center gap-3">
                                  <div class="rounded-1 text-bg-light p-6">
                                    <img src="../assets/images/chat/icon-javascript.svg" alt="flexy-img" width="24" height="24" />
                                  </div>
                                  <div>
                  ...
                  <ul class="chat-users mh-n100" data-simplebar="">
                    <li>
                      <a href="javascript:void(0)" class="px-4 py-3 bg-hover-light-black d-flex align-items-start justify-content-between chat-user bg-light-subtle" id="chat_user_1" data-user-id="1">
                        <div class="d-flex align-items-center">
                          <span class="position-relative">
                            <img src="src\assets\images\profile\user-2.jpg" alt="user1" width="48" height="48" class="rounded-circle" />
                            <span class="position-absolute bottom-0 end-0 p-1 badge rounded-pill bg-success">
                              <span class="visually-hidden">New alerts</span>
                            </span>
                          </span>
                    ...
                    <li>
                      <a href="javascript:void(0)" class="px-4 py-3 bg-hover-light-black d-flex align-items-start justify-content-between chat-user" id="chat_user_5" data-user-id="5">
                        <div class="d-flex align-items-center">
                          <span class="position-relative">
                            <img src="src\assets\images\profile\user-7.jpg" alt="user1" width="48" height="48" class="rounded-circle" />
                            <span class="position-absolute bottom-0 end-0 p-1 badge rounded-pill bg-success">
                              <span class="visually-hidden">New alerts</span>
                            </span>
                          </span>
