          ...
          <div class="page-titles mb-7 mb-md-5">
            <div class="row">
              <div class="col-lg-8 col-md-6 col-12 align-self-center">
                ...
                <h2 class="mb-0 fw-bolder fs-8">Product Detail</h2>
              </div>
                  ...
                  <div class="col-lg-6">
                    <div id="sync1" class="owl-carousel owl-theme">
                      <div class="item rounded-2 overflow-hidden">
                        <img src="src\assets\images\products\s1.jpg" alt="flexy-img" class="img-fluid"/>
                      </div>
                      <div class="item rounded-2 overflow-hidden">
                        <img src="src\assets\images\products\s2.jpg" alt="flexy-img" class="img-fluid"/>
                      </div>
                      <div class="item rounded-2 overflow-hidden">
                        <img src="src\assets\images\products\s3.jpg" alt="flexy-img" class="img-fluid"/>
                      </div>
                      <div class="item rounded-2 overflow-hidden">
                        <img src="src\assets\images\products\s4.jpg" alt="flexy-img" class="img-fluid"/>
                      </div>
                      <div class="item rounded-2 overflow-hidden">
                        <img src="src\assets\images\products\s5.jpg" alt="flexy-img" class="img-fluid"/>
                      </div>
                      <div class="item rounded-2 overflow-hidden">
                        <img src="src\assets\images\products\s6.jpg" alt="flexy-img" class="img-fluid"/>
                      </div>
                      <div class="item rounded-2 overflow-hidden">
                        <img src="src\assets\images\products\s7.jpg" alt="flexy-img" class="img-fluid"/>
                      </div>
                      <div class="item rounded-2 overflow-hidden">
                        <img src="src\assets\images\products\s8.jpg" alt="flexy-img" class="img-fluid"/>
                      </div>
                      <div class="item rounded-2 overflow-hidden">
                        <img src="src\assets\images\products\s9.jpg" alt="flexy-img" class="img-fluid"/>
                      </div>
                      <div class="item rounded-2 overflow-hidden">
                        <img src="src\assets\images\products\s10.jpg" alt="flexy-img" class="img-fluid"/>
                      </div>
                      <div class="item rounded-2 overflow-hidden">
                        <img src="src\assets\images\products\s11.jpg" alt="flexy-img" class="img-fluid"/>
                      </div>
                      <div class="item rounded-2 overflow-hidden">
                        <img src="src\assets\images\products\s12.jpg" alt="flexy-img" class="img-fluid"/>
                      </div>
                    </div>
              ...
              <div class="row">
                <div class="col-sm-6 col-xl-3">
                  <div class="card hover-img overflow-hidden">
                    <div class="position-relative">
                      <a href="javascript:void(0)">
                        <img src="src\assets\images\products\s2.jpg" class="card-img-top" alt="flexy-img" />
                      </a>
                    </div>
                ...
                <div class="col-sm-6 col-xl-3">
                  <div class="card hover-img overflow-hidden">
                    <div class="position-relative">
                      <a href="javascript:void(0)">
                        <img src="src\assets\images\products\s4.jpg" class="card-img-top" alt="flexy-img" />
                      </a>
                    </div>
                    <div class="card-body pt-3 p-4">
                ...
                <div class="col-sm-6 col-xl-3">
                  <div class="card hover-img overflow-hidden">
                    <div class="position-relative">
                      <a href="javascript:void(0)">
                        <img src="src\assets\images\products\s5.jpg" class="card-img-top" alt="flexy-img" />
                      </a>
                    </div>
                    <div class="card-body pt-3 p-4">
                ...
                <div class="col-sm-6 col-xl-3">
                  <div class="card hover-img overflow-hidden">
                    <div class="position-relative">
                      <a href="javascript:void(0)">
                        <img src="src\assets\images\products\s6.jpg" class="card-img-top" alt="flexy-img"/>
                      </a>
                    </div>
                    <div class="card-body pt-3 p-4">
