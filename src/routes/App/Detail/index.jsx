          ...
          <div class="card overflow-hidden">
            <div class="position-relative">
              <a href="javascript:void(0)">
                <img src="src\assets\images\blog\blog-img5.jpg" class="card-img-top rounded-0 object-fit-cover" alt="flexy-img" height="440" />
              </a>
              <span class="badge text-bg-light mb-9 me-9 position-absolute bottom-0 end-0">2
                min Read</span>
              <img src="src\assets\images\profile\user-5.jpg" alt="flexy-img" class="img-fluid rounded-circle position-absolute bottom-0 start-0 mb-n9 ms-9" width="40" height="40" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Esther Lindsey" />
            </div>
              ...
              <div class="position-relative">
                <div class="p-4 rounded-2 text-bg-light mb-3">
                  <div class="d-flex align-items-center gap-3">
                    <img src="../assets/images/profile/user-2.jpg" alt="flexy-img" class="rounded-circle" width="33" height="33" />
