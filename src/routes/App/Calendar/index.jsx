                        ...
                        <table class="table mb-0 align-middle text-nowrap fs-3">
                          <tbody>
                            <tr>
                              <td class="px-0">
                                <div class="d-flex align-items-center">
                                  <img src="src\assets\images\products\product-2.jpg" class="rounded" alt="product" />
                                  <div class="ms-4">
                                    <h5 class="mb-0 fs-4">
                            ...
                            <tr>
                              <td class="px-0">
                                <div class="d-flex align-items-center">
                                  <img src="src\assets\images\products\product-3.jpg" class="rounded" alt="product" />
                                  <div class="ms-4">
                                    <h5 class="mb-0 fs-4">
                            ...
                            <tr>
                              <td class="px-0">
                                <div class="d-flex align-items-center">
                                  <img src="src\assets\images\products\product-1.jpg" class="rounded" alt="product" />
                                  <div class="ms-4">
                                    <h5 class="mb-0 fs-4">
                            ...
                            <tr>
                              <td class="px-0 pb-0">
                                <div class="d-flex align-items-center">
                                  <img src="src\assets\images\products\product-4.jpg" class="rounded" alt="product" />
                                  <div class="ms-4">
                                    <h5 class="mb-0 fs-4">
                    ...
                    <div class="mt-4 pb-4 border-bottom">
                      ...
                      <div class="mt-2 pt-1 mb-2">
                        <a href="javascript:void(0)" class="me-1">
                          <img src="src\assets\images\profile\user-3.jpg" data-bs-toggle="tooltip" data-bs-placement="top" title="John" class="rounded-circle" width="35"/>
                        </a>
                        <a href="javascript:void(0)" class="me-1">
                          <img src="src\assets\images\profile\user-5.jpg" data-bs-toggle="tooltip" data-bs-placement="top" title="Nirav" class="rounded-circle" width="35"/>
                        </a>
                        <a href="javascript:void(0)" class="me-1">
                          <img src="src\assets\images\profile\user-6.jpg" data-bs-toggle="tooltip" data-bs-placement="top" title="Sunil" class="rounded-circle" width="35"/>
                        </a>
                        <a href="javascript:void(0)">
                          <img src="src\assets\images\profile\user-7.jpg" data-bs-toggle="tooltip" data-bs-placement="top" title="Maruti" class="rounded-circle" width="35"/>
                        </a>
                      </div>
                    </div>
