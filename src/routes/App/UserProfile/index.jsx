        ...
        <div class="container-fluid">
          ...
          <div class="card overflow-hidden">
            <div class="card-body p-0">
              <img src="../assets/images/backgrounds/profilebg.jpg" alt="flexy-img" class="img-fluid" />
                    ...
                    <div class="d-flex align-items-center justify-content-center mb-2">
                      <div class="d-flex align-items-center justify-content-center round-110">
                        <div class="border border-4 border-white d-flex align-items-center justify-content-center rounded-circle overflow-hidden round-100">
                          <img src="../assets/images/profile/user-1.jpg" alt="flexy-img" class="w-100 h-100" />
                        </div>
                      </div>
                    </div>
                    <div class="text-center">
                ...
                <div class="col-lg-4">
                  ...
                  <div class="card shadow-none border">
                    <div class="card-body">
                      ...
                      <div class="row">
                        <div class="col-4">
                          <img src="../assets/images/profile/user-1.jpg" alt="flexy-img" class="rounded-1 img-fluid mb-9" />
                        </div>
                        <div class="col-4">
                          <img src="../assets/images/profile/user-2.jpg" alt="flexy-img" class="rounded-1 img-fluid mb-9" />
                        </div>
                        <div class="col-4">
                          <img src="../assets/images/profile/user-3.jpg" alt="flexy-img" class="rounded-1 img-fluid mb-9" />
                        </div>
                        <div class="col-4">
                          <img src="../assets/images/profile/user-4.jpg" alt="flexy-img" class="rounded-1 img-fluid mb-9" />
                        </div>
                        <div class="col-4">
                          <img src="../assets/images/profile/user-5.jpg" alt="flexy-img" class="rounded-1 img-fluid mb-9" />
                        </div>
                        <div class="col-4">
                          <img src="../assets/images/profile/user-6.jpg" alt="flexy-img" class="rounded-1 img-fluid mb-9" />
                        </div>
                        <div class="col-4">
                          <img src="../assets/images/profile/user-7.jpg" alt="flexy-img" class="rounded-1 img-fluid mb-6" />
                        </div>
                        <div class="col-4">
                          <img src="../assets/images/profile/user-8.jpg" alt="flexy-img" class="rounded-1 img-fluid mb-6" />
                        </div>
                        <div class="col-4">
                          <img src="../assets/images/profile/user-1.jpg" alt="flexy-img" class="rounded-1 img-fluid mb-6" />
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-lg-8">
                  ...
                  <div class="card">
                    <div class="card-body border-bottom">
                      <div class="d-flex align-items-center gap-6 flex-wrap">
                        <img src="../assets/images/profile/user-1.jpg" alt="flexy-img" class="rounded-circle" width="40" height="40" />
                      ...
                      <img src="../assets/images/products/s1.jpg" alt="flexy-img" height="360" class="rounded-2 w-100 object-fit-cover" />
                      ...
                      <div class="position-relative">
                        <div class="p-4 rounded-2 text-bg-light mb-3">
                          <div class="d-flex align-items-center gap-6 flex-wrap">
                            <img src="../assets/images/profile/user-3.jpg" alt="flexy-img" class="rounded-circle" width="33" height="33" />
                        ...
                        <div class="p-4 rounded-2 text-bg-light mb-3">
                          <div class="d-flex align-items-center gap-6 flex-wrap">
                            <img src="../assets/images/profile/user-4.jpg" alt="flexy-img" class="rounded-circle" width="33" height="33" />
                        ...
                        <div class="p-4 rounded-2 text-bg-light ms-7">
                          <div class="d-flex align-items-center gap-6 flex-wrap">
                            <img src="../assets/images/profile/user-5.jpg" alt="flexy-img" class="rounded-circle" width="40" height="40" />
                    ...
                    <div class="d-flex align-items-center gap-6 flex-wrap p-3 flex-lg-nowrap">
                      <img src="../assets/images/profile/user-1.jpg" alt="flexy-img" class="rounded-circle" width="33" height="33" />
                  ...
                  <div class="card">
                    <div class="card-body border-bottom">
                      <div class="d-flex align-items-center gap-6 flex-wrap">
                        <img src="../assets/images/profile/user-2.jpg" alt="flexy-img" class="rounded-circle" width="40" height="40" />
                      ...
                      <div class="row">
                        <div class="col-sm-6">
                          <img src="../assets/images/products/s2.jpg" alt="flexy-img" class="img-fluid rounded-2 mb-3 mb-sm-0" />
                        </div>
                        <div class="col-sm-6">
                          <img src="../assets/images/products/s4.jpg" alt="flexy-img" class="img-fluid rounded-2" />
                        </div>
                      </div>
                      <div class="d-flex align-items-center my-3">
                        <div class="d-flex align-items-center gap-2">
                  ...
                  <div class="card">
                    <div class="card-body border-bottom">
                      ...
                      <iframe class="rounded-2 border border-2 mb-3 h-300" src="https://www.youtube.com/embed/d1-FRj20WBE" frameborder="0" width="100%"></iframe>
                      <div class="d-flex align-items-center">
                        <div class="d-flex align-items-center gap-2">
                          <a class="round-32 rounded-circle btn btn-primary p-0 hstack justify-content-center" href="javascript:void(0)" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Like">
                            <i class="ti ti-thumb-up"></i>
            ...
            <div class="tab-pane fade" id="pills-followers" role="tabpanel" aria-labelledby="pills-followers-tab" tabindex="0">
              ...
              <div class="row">
                ...
                <div class=" col-md-6 col-xl-4">
                  <div class="card">
                    <div class="card-body p-4 d-flex align-items-center gap-6 flex-wrap">
                      <img src="../assets/images/profile/user-3.jpg" alt="flexy-img" class="rounded-circle" width="40" height="40" />
                      <div>
                ...
                <div class=" col-md-6 col-xl-4">
                  <div class="card">
                    <div class="card-body p-4 d-flex align-items-center gap-6 flex-wrap">
                      <img src="../assets/images/profile/user-4.jpg" alt="flexy-img" class="rounded-circle" width="40" height="40" />
                      <div>
                ...
                <div class=" col-md-6 col-xl-4">
                  <div class="card">
                    <div class="card-body p-4 d-flex align-items-center gap-6 flex-wrap">
                      <img src="../assets/images/profile/user-6.jpg" alt="flexy-img" class="rounded-circle" width="40" height="40"  />
                      <div>
                ...
                <div class=" col-md-6 col-xl-4">
                  <div class="card">
                    <div class="card-body p-4 d-flex align-items-center gap-6 flex-wrap">
                      <img src="../assets/images/profile/user-7.jpg" alt="flexy-img" class="rounded-circle" width="40" height="40" />
                      <div>
                ...
                <div class=" col-md-6 col-xl-4">
                  <div class="card">
                    <div class="card-body p-4 d-flex align-items-center gap-6 flex-wrap">
                      <img src="../assets/images/profile/user-8.jpg" alt="flexy-img" class="rounded-circle" width="40" height="40" />
                      <div>
                ...
                <div class=" col-md-6 col-xl-4">
                  <div class="card">
                    <div class="card-body p-4 d-flex align-items-center gap-6 flex-wrap">
                      <img src="../assets/images/profile/user-9.jpg" alt="flexy-img" class="rounded-circle" width="40" height="40" />
                      <div>
                ...
                <div class=" col-md-6 col-xl-4">
                  <div class="card">
                    <div class="card-body p-4 d-flex align-items-center gap-6 flex-wrap">
                      <img src="../assets/images/profile/user-10.jpg" alt="flexy-img" class="rounded-circle" width="40" height="40" />
                      <div>
            ...
            <div class="tab-pane fade" id="pills-friends" role="tabpanel" aria-labelledby="pills-friends-tab" tabindex="0">
              ...
              <div class="row">
                <div class="col-sm-6 col-lg-4">
                  <div class="card hover-img">
                    <div class="card-body p-4 text-center border-bottom">
                      <img src="../assets/images/profile/user-1.jpg" alt="flexy-img" class="rounded-circle mb-3" width="80" height="80" />
                      <h5 class="fw-semibold mb-0">Betty Adams</h5>
                ...
                <div class="col-sm-6 col-lg-4">
                  <div class="card hover-img">
                    <div class="card-body p-4 text-center border-bottom">
                      <img src="../assets/images/profile/user-2.jpg" alt="flexy-img" class="rounded-circle mb-3" width="80" height="80" />
                ...
                <div class="col-sm-6 col-lg-4">
                  <div class="card hover-img">
                    <div class="card-body p-4 text-center border-bottom">
                      <img src="../assets/images/profile/user-3.jpg" alt="flexy-img" class="rounded-circle mb-3" width="80" height="80" />
                ...
                <div class="col-sm-6 col-lg-4">
                  <div class="card hover-img">
                    <div class="card-body p-4 text-center border-bottom">
                      <img src="../assets/images/profile/user-4.jpg" alt="flexy-img" class="rounded-circle mb-3" width="80" height="80" />
                ...
                <div class="col-sm-6 col-lg-4">
                  <div class="card hover-img">
                    <div class="card-body p-4 text-center border-bottom">
                      <img src="../assets/images/profile/user-5.jpg" alt="flexy-img" class="rounded-circle mb-3" width="80" height="80" />
                ...
                <div class="col-sm-6 col-lg-4">
                  <div class="card hover-img">
                    <div class="card-body p-4 text-center border-bottom">
                      <img src="../assets/images/profile/user-6.jpg" alt="flexy-img" class="rounded-circle mb-3" width="80" height="80" />
                ...
                <div class="col-sm-6 col-lg-4">
                  <div class="card hover-img">
                    <div class="card-body p-4 text-center border-bottom">
                      <img src="../assets/images/profile/user-7.jpg" alt="flexy-img" class="rounded-circle mb-3" width="80" height="80" />
                ...
                <div class="col-sm-6 col-lg-4">
                  <div class="card hover-img">
                    <div class="card-body p-4 text-center border-bottom">
                      <img src="../assets/images/profile/user-8.jpg" alt="flexy-img" class="rounded-circle mb-3" width="80" height="80" />
                ...
                <div class="col-sm-6 col-lg-4">
                  <div class="card hover-img">
                    <div class="card-body p-4 text-center border-bottom">
                      <img src="../assets/images/profile/user-9.jpg" alt="flexy-img" class="rounded-circle mb-3" width="80" height="80" />
                ...
                <div class="col-sm-6 col-lg-4">
                  <div class="card hover-img">
                    <div class="card-body p-4 text-center border-bottom">
                      <img src="../assets/images/profile/user-10.jpg" alt="flexy-img" class="rounded-circle mb-3" width="80" height="80" />
              ...
              <div class="row">
                <div class="col-md-6 col-lg-4">
                  <div class="card hover-img overflow-hidden">
                    <div class="card-body p-0">
                      <img src="../assets/images/products/s1.jpg" alt="flexy-img" height="220" class="w-100 object-fit-cover" />
                ...
                <div class="col-md-6 col-lg-4">
                  <div class="card hover-img overflow-hidden">
                    <div class="card-body p-0">
                      <img src="../assets/images/products/s2.jpg" alt="flexy-img" height="220" class="w-100 object-fit-cover" />
                      <div class="p-4 d-flex align-items-center justify-content-between">
                        <div>
                ...
                <div class="col-md-6 col-lg-4">
                  <div class="card hover-img overflow-hidden">
                    <div class="card-body p-0">
                      <img src="../assets/images/products/s3.jpg" alt="flexy-img" height="220" class="w-100 object-fit-cover" />
                      <div class="p-4 d-flex align-items-center justify-content-between">
                        <div>
                ...
                <div class="col-md-6 col-lg-4">
                  <div class="card hover-img overflow-hidden">
                    <div class="card-body p-0">
                      <img src="../assets/images/products/s4.jpg" alt="flexy-img" height="220" class="w-100 object-fit-cover" />
                      <div class="p-4 d-flex align-items-center justify-content-between">
                        <div>
                ...
                <div class="col-md-6 col-lg-4">
                  <div class="card hover-img overflow-hidden">
                    <div class="card-body p-0">
                      <img src="../assets/images/products/s5.jpg" alt="flexy-img" height="220" class="w-100 object-fit-cover" />
                      <div class="p-4 d-flex align-items-center justify-content-between">
                        <div>
                ...
                <div class="col-md-6 col-lg-4">
                  <div class="card hover-img overflow-hidden">
                    <div class="card-body p-0">
                      <img src="../assets/images/products/s6.jpg" alt="flexy-img" height="220" class="w-100 object-fit-cover" />
                      <div class="p-4 d-flex align-items-center justify-content-between">
                        <div>
                ...
                <div class="col-md-6 col-lg-4">
                  <div class="card hover-img overflow-hidden">
                    <div class="card-body p-0">
                      <img src="../assets/images/products/s7.jpg" alt="flexy-img" height="220" class="w-100 object-fit-cover" />
                      <div class="p-4 d-flex align-items-center justify-content-between">
                        <div>
                ...
                <div class="col-md-6 col-lg-4">
                  <div class="card hover-img overflow-hidden">
                    <div class="card-body p-0">
                      <img src="../assets/images/products/s8.jpg" alt="flexy-img" height="220" class="w-100 object-fit-cover"  />
                      <div class="p-4 d-flex align-items-center justify-content-between">
                        <div>
                ...
                <div class="col-md-6 col-lg-4">
                  <div class="card hover-img overflow-hidden">
                    <div class="card-body p-0">
                      <img src="../assets/images/products/s9.jpg" alt="flexy-img" height="220" class="w-100 object-fit-cover"/>
                      <div class="p-4 d-flex align-items-center justify-content-between">
                        <div>
                ...
                <div class="col-md-6 col-lg-4">
                  <div class="card hover-img overflow-hidden">
                    <div class="card-body p-0">
                      <img src="../assets/images/products/s10.jpg" alt="flexy-img" height="220" class="w-100 object-fit-cover" />
                      <div class="p-4 d-flex align-items-center justify-content-between">
                        <div>
                ...
                <div class="col-md-6 col-lg-4">
                  <div class="card hover-img overflow-hidden">
                    <div class="card-body p-0">
                      <img src="../assets/images/products/s11.jpg" alt="flexy-img" height="220" class="w-100 object-fit-cover"  />
                      <div class="p-4 d-flex align-items-center justify-content-between">
                        <div>
                ...
                <div class="col-md-6 col-lg-4">
                  <div class="card hover-img overflow-hidden">
                    <div class="card-body p-0">
                      <img src="../assets/images/products/s12.jpg" alt="flexy-img" height="220" class="w-100 object-fit-cover" />
                      <div class="p-4 d-flex align-items-center justify-content-between">
                        <div>
