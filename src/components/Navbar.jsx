            ...
            <ul id="sidebarnav">
              ...
              <li className="sidebar-item">
                ...
                <ul aria-expanded="false" className="collapse first-level">
                  ...
                  <li className="sidebar-item">
                    <a href="/kanban" className="sidebar-link">
                  ...
                  <li className="sidebar-item">
                    <a href="/contact2" className="sidebar-link">
                  ...
                  <li className="sidebar-item">
                    <a href="/page-user-profile" className="sidebar-link">
                      <i className="ti ti-user-circle" />
                      <span className="hide-menu">User Profile</span>
                    </a>
                  </li>
                  <li className="sidebar-item">
                    <a href="/blog-posts" className="sidebar-link">
                      <i className="ti ti-article" />
                      <span className="hide-menu">Posts</span>
                    </a>
                  </li>
                  <li className="sidebar-item">
                    <a href="/blog-detail" className="sidebar-link">
                      <i className="ti ti-details" />
                      <span className="hide-menu">Detail</span>
                    </a>
                  </li>
                  <li className="sidebar-item">
                    <a href="/eco-shop" className="sidebar-link">
                      <i className="ti ti-shopping-cart" />
                      <span className="hide-menu">Shop</span>
                    </a>
                  </li>
                  <li className="sidebar-item">
                    <a href="/eco-shop-detail" className="sidebar-link">
